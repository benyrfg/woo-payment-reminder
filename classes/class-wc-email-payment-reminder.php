...
class WC_Email_Payment_Reminder extends WC_Email {
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'hours_to_send_first' => array(
                'title'       => __( 'Hours before first reminder', 'woo-payment-reminder' ),
                'type'        => 'number',
                'default'     => '168',
                'desc_tip'    => true,
            ),
            'enable_second_reminder' => array(
                'title'   => __( 'Second reminder', 'woo-payment-reminder' ),
                'type'    => 'checkbox',
                'label'   => __( 'Enable second reminder email', 'woo-payment-reminder' ),
                'default' => 'yes',
            ),
            'hours_to_send_second' => array(
                'title'       => __( 'Hours before second reminder', 'woo-payment-reminder' ),
                'type'        => 'number',
                'default'     => '240',
                'desc_tip'    => true,
                'class'       => 'wpr-second-reminder-field',
            ),
            'subject'    => array(
